...
public class SceneChanger : MonoBehaviour
{
    ...
    static int testNumber; //you have to make it static to carry the value b/w scenes
    public int testNumberDisplay; 

    // Start is called before the first frame update
    void Start()
    {
        //Debug.Log("printed at start. testNumber = " + testNumber); //print to console

    }

    private void Awake()
    {
        Debug.Log("printed at awake. testNumber = " + testNumber); //print to console
    ...
    public void StartScene() //go to Start Scene
    {
        ...
        if (Input.GetKeyDown(KeyCode.S))
        {
            //Debug.Log("StartScene() Called"); //print to console
            sceneNumber = 1;
            testNumber++; //add 1 to testNumber
            SceneManager.LoadScene("Tori's Start Scene"); //Load Start Scene
        }
        else if (Input.GetKeyDown(KeyCode.M))
        {
            ...
            sceneNumber = 2;
            testNumber++; //add 1 to testNumber
            SceneManager.LoadScene("Tori's Level 1"); //Load Main Scene
        }
    }
    ...
    public void EndScene() //go to End Scene when a key is pressed
    {
        ...
        //if (Input.GetKeyDown(sceneKey)) //if sceneKey is pressed, called only once
        {
            ...
            sceneNumber = 3;
            testNumber++; //add 1 to testNumber
            SceneManager.LoadScene("Tori's End Scene"); //Load End Scene
        }
        //Debug.Log("EndScene() Called"); //print to console
